...
?>
<section class="all-callcenter">
        <div class="container">
            <div class="row">
              <div class="col-lg-2 text-center">
                    <div class="hot-line-text-icon">
                        <span><i class="fa fa-phone-volume" aria-hidden="true"></i></span>
                        <p>হটলাইন</p>
                    </div>
                </div>
                <div class="col-lg-2 text-center">
                ...
                <div class="col-lg-2 text-center">
                    <div class="hot-line-text">
                        <span>০৯৬১১৬৭৭৭৭৭</span>
                        <p>বিশেষজ্ঞ হেলথ লাইন</p>
                    </div>
                </div>
                <div class="col-lg-2 text-center">
                    <div class="hot-line-text">
