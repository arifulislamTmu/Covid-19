...
<body>
	...
	<?php
        ...
        if(isset($_POST['subbtn'])){
            ...
            if(empty($to) or empty($message)){
                echo "<span style='color:red; font-size:20px;'> field must not be empty</span><br>";
            }else{

			$otp = mt_rand(100000, 999999);
			$message = "Hello " . $_POST['message'] . " This is your OTP: " . $otp;

			try {
            $setcookie = setcookie('otp', $otp);
              echo $otp;
                echo "<span style='color:black; font-size:20px; margin-top:10px;'>একটি এসএমএস দ্বারা আপনার কাছে একটি ৬ ডিজিটের কোড প্রেরণ করা হয়েছে !</span><br>";
			...
			if($_COOKIE['otp'] == $otp) {
               ...
               if(isset($_POST['verifyotp'])){
				...
				<script>
					  ...
					  alert("আপনার পিন নম্বরটি সঠিক নয়");
